...
| Servo/Stepper driver | [Lichuan AC servo driver (PUL/DIR interface)](https://s.click.aliexpress.com/e/_c3kWTQaX) |
...
| Component | Link |
| --- | --- |
| AC Servo motor + driver | [AliExpress](https://s.click.aliexpress.com/e/_c3kWTQaX) |

**Recommended model: 1,000 W** — select the "1KW 4Nm 17b incremt" option (model **LCMT-10SLC17NB-80M04025B**): 4 Nm torque, 2500 RPM, 80 mm mounting flange (same specs as the unit used in this project).
